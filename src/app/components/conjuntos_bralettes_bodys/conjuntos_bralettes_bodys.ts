...
@Component({
  selector: 'app-conjuntos-bralettes-bodys',
  imports: [CommonModule, NavbarComponent, RouterLink, FooterComponent],
  templateUrl: './conjuntos_bralettes_bodys.html',
  styleUrls: ['./conjuntos_bralettes_bodys.css']
})
export class ConjuntosBralettesBodysComponent implements OnInit {
  ...
  allowedCategories = [
    'Panty', 'niña', 'Conjunto', 'Bralette',
    'Body', 'Corpiño', 'Parte_inferior'
  ];
